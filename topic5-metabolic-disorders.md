...
1. **Small molecule diseases** - accumulation of toxic metabolites
   ...
   - Organic acidemias
   - Urea cycle defects
2. **Large molecule diseases** - storage of complex molecules
   - Lysosomal storage disorders
   - Mucopolysaccharidoses
   - Glycogen storage diseases
3. **Energy metabolism defects**
   - Fatty acid oxidation disorders
   - Mitochondrial disorders

### Key Counseling Concepts
- **Newborn screening**: Early detection → prevention of irreversible damage
- **Dietary management**: Lifelong compliance challenges
- **Carrier screening**: Population-specific risks
- **Enzyme replacement**: Cost, access, effectiveness
...
- **Confirmation**: Plasma amino acids, PAH gene sequencing
- **Classification**:
  - Classic PKU: Phe >1200 μmol/L
  - Moderate PKU: Phe 600-1200 μmol/L
...
- **New therapies**: 
  - Sapropterin (Kuvan) - BH4 cofactor supplementation
  - Pegvaliase (Palynziq) - enzyme substitution therapy
- **Goal Phe levels**: 
  - <12 years: 120-360 μmol/L
...
- **Testing**: 
  ...
  - Plasma methionine (elevated in CBS deficiency)
  - Urine homocystine
...
- **Neurologic**: ID despite treatment
...
- **Diet**: STRICT galactose restriction
  ...
  - Avoid dairy, organ meats, some fruits/vegetables
- **Monitoring**: 
  - Gal-1-P levels
  - Ophthalmology
